    ...
    return (
        ...
        <div className="card">
            <div className="image-container">
                <div className="image-container">
                    <img src="https://5.imimg.com/data5/SELLER/Default/2022/3/BK/TA/UG/148618475/vivo-y19-mobile-phones.jpg" alt="Product Image" className="product-image" />
                </div>
            ...
            <div className="content">
                ...
                <div className="product-name">classNameic oversized hoodie</div>
            ...
            <div className="button-container">
                <button className="buy-button button" onClick={() => navigate("/shop/:demo")}>Buy Now</button>
