...
function AddVariants() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (images.filter((item) => item.data === "").length > 0) {
      ...
      <div className="add-variant w-full h-full flex flex-col md:flex-row justify-center gap-2 overflow-auto">
        <div className="base-info w-full md:w-1/2 rounded-md border border-gray-400 ">
          ...
          <div className="w-11/12 ml-5 mt-5">
            ...
            <select id="countries" name="selectedProduct" onChange={handleSelect} value={data.selectedProduct} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
          ...
          <div className="images-container ml-5  mt-5 mb-5 w-11/12">
            {images.map((item) => (
              <ImageUpload added={added} key={item.key} data={item} updateImages={updateImages} />
            ))}
        ...
        <div className="product-details-container w-full md:w-1/2 rounded-md border border-gray-400 ">
          ...
          <div className="w-11/12 ml-5 mt-5 flex justify-between flex-wrap">
            <div className="mt-1 w-100">
              ...
              <input name="ram" value={data.ram} onChange={handleChange} placeholder="Enter ram" type="number" className="bg-white-50 border border-white-500 text-sm rounded-lg  block p-2.5 dark:bg-gray-800  " />
            ...
            <div className="mt-1 w-100">
              ...
              <input name="rom" value={data.rom} onChange={handleChange} type="number" placeholder="Enter Rom" className="bg-white-50 border border-white-500 text-sm rounded-lg  block p-2.5 dark:bg-gray-800  " />
            ...
            <div className="mt-1 w-100">
              ...
              <input name="mrp" value={data.mrp} onChange={handleChange} type="number" placeholder="Enter mrp" className="bg-white-50 border border-white-500 text-sm rounded-lg  block p-2.5 dark:bg-gray-800  " />
            ...
            <div className="mt-1 w-100">
              ...
              <input placeholder="Enter Variant Price" name="price" value={data.price} onChange={handleChange} type="number" className="bg-white-50 border border-white-500 text-sm rounded-lg  block p-2.5 dark:bg-gray-800  " />
            ...
            <div className="mt-1 w-100">
              ...
              <input placeholder="Enter color name" name="color" value={data.color} onChange={handleChange} type="text" className="bg-white-50 border border-white-500 text-sm rounded-lg  block p-2.5 dark:bg-gray-800  " />
            ...
            <div className="mt-1 w-100">
              ...
              <input placeholder="Enter color code" name="colorCode" value={data.colorCode} onChange={handleChange} type="text" className="bg-white-50 border border-white-500 text-sm rounded-lg  block p-2.5 dark:bg-gray-800  " />
            ...
            <div className="mt-1 w-100">
              ...
              <input placeholder="Enter quantity" name="quantity" value={data.quantity} onChange={handleChange} type="number" className="bg-white-50 border border-white-500 text-sm rounded-lg  block p-2.5 dark:bg-gray-800  " />
