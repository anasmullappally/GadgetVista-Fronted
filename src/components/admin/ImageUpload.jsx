...
function ImageUpload({ data, updateImages }) {
    ...
    const handleImageChange = (e) => {
        ...
        updateImages(data.key, file)
        // if (file) {
        //     const reader = new FileReader();
        //     reader.onloadend = () => {
        //         setSelectedImage(reader.result);
        //         updateImages(data.key, file); // Pass the key and file object
        //     };
        ...
        updateImages((prevImages) => {
            return prevImages.map((item) => {
                if (item.key === data.key) {
                    return { ...item, data: null, preview: null }; // Corrected: image, not data
                }
                return item;
            });
        });
            ...
            {selectedImage ?
                <div className="image-preview-container">
                    <div className="image-preview">
                        ...
                        <div className="delete-icon" onClick={handleDeleteImage}>
                            <CiCircleRemove />
                        </div>
                    </div>
                </div>
