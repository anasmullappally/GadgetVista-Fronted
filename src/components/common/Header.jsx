...
function Header() {
  ...
  const navigation = [
    { title: "Home", path: "javascript:void(0)", isDropdown: false },
    { title: "Phones", path: "javascript:void(0)", isDropdown: false },
    { title: "About", path: "javascript:void(0)", isDropdown: false },
    { title: "Contact Us", path: "javascript:void(0)", isDropdown: false },
  ];
